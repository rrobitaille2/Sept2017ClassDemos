    ...
    <uc1:MessageUserControl runat="server" ID="MessageUserControl" />
     <div class="row">
        <div class="col-md-12">
         ...
         <%-- Some people will place all ODS controls in one location for ease of viewing
             it is not necessary. Any ODS on the page is available to all tabs.--%>

         <%-- to install a RadioButtonList, one can use the Edit Items to create the
             individual selections, one can change the default Vertical/Table layout
