<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master"
     AutoEventWireup="true" CodeFile="AlbumsByYearRange.aspx.cs" 
    Inherits="SamplePages_AlbumsByYearRange" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" 
    ...
    <asp:GridView ID="AlbumsList" runat="server"
        ...
        DataSourceID="AlbumsListODS" AllowPaging="True">
        <Columns>
    ...
    <asp:ObjectDataSource ID="AlbumsListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Albums_FindByYearRange" TypeName="ChinookSystem.BLL.AlbumController">
        <SelectParameters>
            <asp:ControlParameter ControlID="minyear" 
                PropertyName="Text" DefaultValue="1990" 
